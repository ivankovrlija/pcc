<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0" marginwidth="0" marginheight="0" width="100%" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; width: 100%; height: 100%; -webkit-font-smoothing: antialiased; text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; line-height: 100%;
	...
	max-width: 600px;" class="wrapper">
			...
			color: #FFFFFF;" class="preheader">
                            ...
                            <a target="_blank" style="text-decoration: none;" href="javascript:;"><img border="0" vspace="0" hspace="0" src="{{ asset('images/emails/logo-white.png') }}" width="100" height="30" alt="Logo" title="Logo" style="
				color: #000000;
			...
			font-family: sans-serif;" class="header">
                            <p>Explore responsive email templates</p>
                        </td>
                    </tr>
			...
			padding-top: 20px;" class="hero"><a target="_blank" style="text-decoration: none;" href="javascript:;"><img border="0" vspace="0" hspace="0" src="{{ asset('images/emails/hero-grid.png') }}" alt="Please enable images to view this content" title="Hero Image" width="530" style="
			width: 88.33%;
			max-width: 530px;
			...
			font-family: sans-serif;" class="paragraph">
                    ...
                    <tr>
                        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
			padding-top: 25px;
			padding-bottom: 35px;" class="button"><a href="javascript:;" target="_blank" style="text-decoration: underline;">
	...
	max-width: 600px;">
			...
			font-size: 17px; line-height: 160%;" href="javascript:;"><img border="0" vspace="0" hspace="0" src="{{ asset('images/emails/hero-grid.png') }}" width="250" height="142" alt="Grid Item" title="Grid Item" style="
			color: #000000; font-size: 10px; margin: 0; padding: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: block; margin-bottom: 8px;" />
                                            <b style="color:#0B5073; text-decoration: underline;">General template</b></a><br />
                                        <p>The&nbsp;perfect choice for any purpose of a&nbsp;message.</p>
                                    </td>
                                </tr>
                            </table>
			...
			color: #000000; font-size: 10px; margin: 0; padding: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: block; margin-bottom: 8px;" />
                                        ...
                                        <p>The&nbsp;one with an&nbsp;action button seen without scrolling.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
			...
			color: #000000; font-size: 10px; margin: 0; padding: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: block; margin-bottom: 8px;" />
                                        ...
                                        <p>The&nbsp;best for introducing a&nbsp;feature or&nbsp;inviting to an&nbsp;action.</p>
                                    </td>
                                </tr>
                            </table>
                            <table width="280" border="0" cellpadding="0" cellspacing="0" align="left" valign="top" style="border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0; margin: 0; padding: 0; display: inline-table; float: none;" class="floater">
			...
			color: #000000; font-size: 10px; margin: 0; padding: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: block; margin-bottom: 8px;" />
                                        ...
                                        <p>Great&nbsp;one for offering a&nbsp;variety of&nbsp;options to&nbsp;explore.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
